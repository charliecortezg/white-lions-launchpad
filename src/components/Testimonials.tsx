        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div 
                key={index}
                className="bg-card rounded-2xl p-8 shadow-lg hover:shadow-gold transition-all duration-300 hover:-translate-y-1"
              >
                {/* Stars */}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16 p-8 bg-card rounded-3xl border border-gold/20">
            ...
            <div className="text-center">
              <div className="text-4xl font-bold text-gold mb-2">300+</div>
